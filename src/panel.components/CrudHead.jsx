...
export default function CrudHead({
    ...
    return (
        <section
            className="relative z-10 grid gap-4 grid-cols-1 md:grid-cols-4 lg:grid-cols-3 bg-[--c2] rounded-lg border-solid border-t-[3px] border-[var(--c1)] shadow-[0_2px_5px_0_rgba(0,0,0,0.3)]"
            style={{
                margin: isOpen ? "0" : "0",
        ...
        >
            <div className="col-span-1 xl:col-span-1">
                <h3 className="flex gap-1 w-full h-full items-center justify-center md:justify-start font-content2 font-bold text-md text-[var(--c1)]">
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-1 flex w-full h-8 items-center rounded-md overflow-hidden border border-solid border-[--c1]">
                <span className="flex justify-center items-center h-full px-2 bg-[--c2] text-[--c1]">
                    Buscar:{" "}
                </span>
                <div className="flex items-center w-full h-full px-2 bg-[--c2]">
                    <FontAwesomeIcon icon={faSearch} className="text-[--c1]" />
                    <input
                        type="search"
                        placeholder="Busca por cualquier campo.."
                        value={searchValue}
                        onChange={searchOnChange}
                        className="w-full pl-1 bg-[--c2]"
                    />
                </div>
            </div>
